...
{
    /// <summary>
    /// CoinEx Futures account endpoints. Account endpoints include balance info, withdraw/deposit info and requesting and account settings
    /// </summary>
    public interface ICoinExClientFuturesApiAccount
    {
        ...
        /// <para><a href="https://docs.CoinEx.com/futures/#get-transaction-history" /></para>
        /// </summary>
        ...
        Task<WebCallResult<CoinExDepositAddress>> GetDepositAddressAsync(string asset, CancellationToken ct = default);

        /// <summary>
        /// Get deposit history
        /// <para><a href="https://docs.CoinEx.com/futures/#get-deposits-list" /></para>
        /// </summary>
        /// <param name="asset">Filter by asset</param>
        ...
        Task<WebCallResult<CoinExPaginated<CoinExDeposit>>> GetDepositHistoryAsync(string? asset = null, DepositStatus? status = null, DateTime? startTime = null, DateTime? endTime = null, int? currentPage = null, int? pageSize = null, CancellationToken ct = default);

        /// <summary>
        /// Get the withdrawal limit
        /// <para><a href="https://docs.CoinEx.com/futures/#get-withdrawal-limit" /></para>
        /// </summary>
        /// <param name="asset">The asset to get limits for</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns>Withdrawal limit info</returns>
        Task<WebCallResult<CoinExFuturesWithdrawalQuota>> GetWithdrawalLimitAsync(string asset, CancellationToken ct = default);

        /// <summary>
        /// Withdraw funds
        /// <para><a href="https://docs.CoinEx.com/futures/#withdraw-funds" /></para>
        /// </summary>
        ...
        Task<WebCallResult<CoinExNewWithdrawal>> WithdrawAsync(string asset, string address, decimal quantity, bool? isInner = null, string? remark = null, string? chain = null, string? memo = null, CancellationToken ct = default);

        /// <summary>
        /// Get withdraw history
        /// <para><a href="https://docs.CoinEx.com/futures/#get-withdrawal-list" /></para>
        /// </summary>
        /// <param name="asset">Filter by asset</param>
        /// <param name="status">Filter by status</param>
        /// <param name="startTime">Filter by start time</param>
        ...
        Task<WebCallResult<CoinExPaginated<CoinExWithdrawal>>> GetWithdrawHistoryAsync(string? asset = null, WithdrawalStatus? status = null, DateTime? startTime = null, DateTime? endTime = null, int? currentPage = null, int? pageSize = null, CancellationToken ct = default);

        /// <summary>
        /// Cancel a withdrawal in process
        /// <para><a href="https://docs.CoinEx.com/futures/#cancel-withdrawal" /></para>
        /// </summary>
        ...
        /// <para><a href="https://docs.CoinEx.com/futures/#transfer-funds-to-CoinEx-main-account-2" /></para>
        /// </summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Withdrawal id</returns>
        Task<WebCallResult<CoinExTransferResult>> TransferToMainAccountAsync(string asset, decimal quantity, string? clientId = null, CancellationToken ct = default);

        /// <summary>
        /// Cancel a transfer from futures account to main account
        /// <para><a href="https://docs.CoinEx.com/futures/#cancel-transfer-out-request" /></para>
        /// </summary>
        ...
        /// <para><a href="https://docs.CoinEx.com/futures/#get-transfer-out-request-records-2" /></para>
        /// </summary>
        /// <param name="asset">Filter by asset</param>
        /// <param name="startTime">Filter by start time</param>
        /// <param name="endTime">Filter by end time</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<CoinExPaginated<CoinExTransfer>>> GetTransferToMainAccountHistoryAsync(string asset, DateTime? startTime = null, DateTime? endTime = null, int? currentPage = null, int? pageSize = null, CancellationToken ct = default);


        /// <summary>
        /// Get the total value of active orders
        /// <para><a href="https://docs.CoinEx.com/futures/#active-order-value-calculation" /></para>
        /// </summary>        
        /// <param name="symbol">Symbol</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<CoinExOrderValuation>> GetOpenOrderValueAsync(string symbol, CancellationToken ct = default);

        /// <summary>
        /// Get details on a position
        /// <para><a href="https://docs.CoinEx.com/futures/#get-position-details" /></para>
        /// </summary>
        /// <param name="symbol">Contract symbol</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns>Position info</returns>
        Task<WebCallResult<CoinExPosition>> GetPositionAsync(string symbol, CancellationToken ct = default);

        /// <summary>
        /// Get list of positions
        /// <para><a href="https://docs.CoinEx.com/futures/#get-position-list" /></para>
        /// </summary>
        /// <param name="ct">Cancellation token</param>
        /// <returns>Position info</returns>
        Task<WebCallResult<IEnumerable<CoinExPosition>>> GetPositionsAsync(CancellationToken ct = default);

        /// <summary>
        /// Enable/disable auto deposit margin
        /// <para><a href="https://docs.CoinEx.com/futures/#enable-disable-of-auto-deposit-margin" /></para>
        /// </summary>
        ...
        /// <summary>
        /// Add margin
        /// <para><a href="https://docs.CoinEx.com/futures/#add-margin-manually" /></para>
        /// </summary>
        /// <param name="symbol">Symbol</param>
        ...
        /// <summary>
        /// Get funding history
        /// <para><a href="https://docs.CoinEx.com/futures/#get-funding-history" /></para>
        /// </summary>
        /// <param name="symbol">Symbol</param>
        /// <param name="startTime">Filter by start time</param>
        /// <param name="endTime">Filter by end time</param>
